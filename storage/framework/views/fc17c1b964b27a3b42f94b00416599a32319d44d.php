      ...
      <div class="navbar-custom-menu">
        ...
        <ul class="nav navbar-nav">
          <li class="dropdown messages-menu">
            <a href="<?php echo e(URL::to('/viewcart')); ?>" class="btn btn-dark">
              <i class="fa fa-eye"  style="font-size:18px"></i>

              <span class="title"><?php echo app('translator')->getFromJson('website.View Cart'); ?></span>
              <?php if(count($cart_data)>0): ?>
                <span class="items"><?php echo e(count($cart_data)); ?>&nbsp;<?php echo app('translator')->getFromJson('website.items'); ?></span>
              <?php else: ?>
                    ...
                    <a href="<?php echo e(URL::to("admin/viewOrder")); ?>/<?php echo e($unseenOrder->orders_id); ?>">
                      <div class="pull-left">
                         ...
                         <?php if(!empty($unseenOrder->customers_picture)): ?>
                            ...
                            <?php else: ?>
                            <img src="<?php echo e(asset('backend/images/default_images/user.png')); ?>" class="img-circle" alt="<?php echo e($unseenOrder->customers_name); ?> Image">
                         <?php endif; ?>
                    ...
                    <a href="<?php echo e(URL::to("admin/editCustomers")); ?>/<?php echo e($newCustomer->customers_id); ?>">
                      <div class="pull-left">
                         <?php if(!empty($newCustomer->customers_picture)): ?>
                            ...
                            <?php else: ?>
                            <img src="<?php echo e(asset('backend/images/default_images/user.png')); ?>" class="img-circle" alt="<?php echo e($newCustomer->customers_firstname); ?> Image">
                         <?php endif; ?>
                      </div>
                      <h4>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="<?php echo e(URL::to('backend')); ?>" class="btn btn-default btn-flat"><?php echo e(trans('labels.sign_out')); ?></a>
                </div>
              </li>
            </ul>
          </li>
