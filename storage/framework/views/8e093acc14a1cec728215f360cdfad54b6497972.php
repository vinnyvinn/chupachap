<script src="<?php echo asset('backend/plugins/jQuery/jQuery-2.2.0.min.js'); ?>"></script>
<script src="<?php echo asset('backend/bootstrap/js/bootstrap.min.js'); ?>"></script>
<script src="<?php echo asset('backend/plugins/select2/select2.full.min.js'); ?>"></script>
...
<script src="<?php echo asset('backend/plugins/datepicker/bootstrap-datepicker.js'); ?>"></script>

<!-- bootstrap color picker -->
<script src="<?php echo asset('backend/plugins/colorpicker/bootstrap-colorpicker.min.js'); ?>"></script>
<!-- bootstrap time picker -->
<script src="<?php echo asset('backend/plugins/timepicker/bootstrap-timepicker.min.js'); ?>"></script>
<!-- SlimScroll 1.3.0 -->
<script src="<?php echo asset('backend/plugins/slimScroll/jquery.slimscroll.min.js'); ?>"></script>
<!-- iCheck 1.0.1 -->
<script src="<?php echo asset('backend/plugins/iCheck/icheck.min.js'); ?>"></script>
<!-- FastClick -->
<script src="<?php echo asset('backend/plugins/fastclick/fastclick.js'); ?>"></script>
<!-- AdminLTE App -->
<script src="<?php echo asset('backend/dist/js/app.min.js'); ?>"></script>
<?php if(Request::path() == 'backend/dashboard/last_year' or Request::path() == 'backend/dashboard/last_month' or Request::path() == 'backend/dashboard/this_month'): ?>
    <!--<script src="<?php echo asset('backend/dist/js/pages/dashboard.js'); ?>"></script>-->
<?php endif; ?>
<!-- AdminLTE for demo purposes -->
<script src="<?php echo asset('backend/js/demo.js'); ?>"></script>

<script src="<?php echo asset('backend/plugins/chartjs/Chart.min.js'); ?>"></script>
<script src="<?php echo asset('backend/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js'); ?>"></script>
<script src="<?php echo asset('backend/plugins/jvectormap/jquery-jvectormap-world-mill-en.js'); ?>"></script>
<script src="<?php echo asset('backend/plugins/sparkline/jquery.sparkline.min.js'); ?>"></script>
...
$(document).on('click', '.add-value', function(e){
	...
	$.ajax({
		url: '<?php echo e(URL::to("backend/addattributevalue")); ?>',
		type: "POST",
		data: formData,
...
$(document).on('click', '.update-value', function(e){
	...
	$.ajax({
		url: '<?php echo e(URL::to("backend/updateattributevalue")); ?>',
		type: "POST",
		data: formData,
		success: function (res) {
				$('.addError').hide();
...
$(document).on('click', '#deleteAttribute', function(e){
	...
	var formData = parentFrom.serialize();
	$.ajax({
		url: '<?php echo e(URL::to("backend/deletevalue")); ?>',
		type: "POST",
		data: formData,
		success: function (res) {
				$('.addError').hide();
...
$(document).on('click', '#addAttribute', function(e){
	...
	$.ajax({
		url: '<?php echo e(URL::to("backend/addnewproductattribute")); ?>',
		type: "POST",
		data: formData,
		success: function (res) {
...
$(document).on('click', '#addDefaultAttribute', function(e){
	...
	$.ajax({
		url: '<?php echo e(URL::to("backend/addnewdefaultattribute")); ?>',
		type: "POST",
		data: formData,
		success: function (res) {
...
$(document).on('change', '#entry_country_id', function(e){
	...
	$.ajax({
	  url: "<?php echo e(URL::to('backend/getZones')); ?>",
	  dataType: 'json',
	  type: "post",
...
$(document).on('click', '#addAddress', function(e){
	...
	$.ajax({
		url: '<?php echo e(URL::to("backend/addNewCustomerAddress")); ?>',
		type: "POST",
		data: formData,
		async: false,
		success: function (res) {
...
$(document).on('click', '.editAddressModal', function(){
	...
	$.ajax({
		url: "<?php echo e(URL::to('backend/editAddress')); ?>",
		type: "POST",
...
$(document).on('click', '.editproductattributemodal', function(){
	...
	$.ajax({
		url: '<?php echo e(URL::to("backend/editproductattribute")); ?>',
		type: "POST",
...
$(document).on('click', '.editdefaultattributemodal', function(){
	...
	var options_id = $(this).attr('options_id');
	$.ajax({
		url: "<?php echo e(URL::to('backend/editdefaultattribute')); ?>",
		type: "POST",
		data: '&products_id='+products_id+'&products_attributes_id='+products_attributes_id+'&language_id='+language_id+'&options_id='+options_id,
		success: function (data) {
...
$(document).on('click', '#updateAddress', function(e){
		...
		$.ajax({
			url: "<?php echo e(URL::to('backend/updateAddress')); ?>",
			type: "POST",
			data: formData,
			success: function (res) {
	...
	$(document).on('click', '#updateProductAttribute', function(e){
		...
		$.ajax({
			url: '<?php echo e(URL::to("backend/updateproductattribute")); ?>',
			type: "POST",
			data: formData,
			success: function (res) {
	...
	$(document).on('click', '#updateDefaultAttribute', function(e){
		...
		$.ajax({
			url: "<?php echo e(URL::to('backend/updatedefaultattribute')); ?>",
			type: "POST",
			data: formData,
			success: function (res) {
	...
	$(document).on('click', '#deleteAddressBtn', function(){
		...
		$.ajax({
			url: "<?php echo e(URL::to('backend/deleteAddress')); ?>",
			type: "POST",
			data: formData,
			success: function (res) {
	...
	$(document).on('click', '.deleteproductattributemodal', function(){
		...
		var products_attributes_id = $(this).attr('products_attributes_id');
		$.ajax({
			url: "<?php echo e(URL::to('backend/deleteproductattributemodal')); ?>",
			type: "POST",
	...
	$(document).on('click', '.deletedefaultattributemodal', function(){
		...
		var products_attributes_id = $(this).attr('products_attributes_id');
		$.ajax({
			url: "<?php echo e(URL::to('backend/deletedefaultattributemodal')); ?>",
			type: "POST",
			data: '&products_id='+products_id+'&products_attributes_id='+products_attributes_id,
			success: function (data) {
	...
	$(document).on('click', '.deleteOption', function(){
		...
		$.ajax({
			url: "<?php echo e(URL::to('backend/checkattributeassociate')); ?>",
			type: "POST",
	...
	$(document).on('click', '.delete-value', function(){
		...
		$.ajax({
			url: "<?php echo e(URL::to('backend/checkvalueassociate')); ?>",
			type: "POST",
...
jQuery(document).on('click', '.add-to-Cart', function(e){
	...
	var message;
	jQuery.ajax({
		url: '<?php echo e(URL::to("/admin/addToCart")); ?>',
		type: "POST",
		data: formData,
...
$(function () {
 ...
 $('#existing-customers').on("click",function () {
...
function enrolled(customer_id) {
    var url = '<?php echo e(url('admin/enroll')); ?>' + '/'+customer_id;
    var posturl = '<?php echo e(url('admin/save-enroll')); ?>' + '/'+customer_id;
