        ...
        <div class="box">
          <div class="box-header">
            ...
            <div class="box-tools pull-right">
                <a href="<?php echo e(URL::to('admin/importproducts')); ?>" type="button" class="btn btn-success"><?php echo e(trans('labels.ImportNewProducts')); ?></a>
            	<a href="<?php echo e(URL::to('admin/addproduct')); ?>" type="button" class="btn btn-primary"><?php echo e(trans('labels.AddNewProducts')); ?></a>
            </div>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
            ...
            <div class="row">
            	<div class="col-xs-12">
                    <form class="form-inline form-validate" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                          <input type="text" name="serial" class="form-control" id="exampleInputPassword3"
                              <?php if(isset($_REQUEST['product']->serial) and !empty($_REQUEST['product']->serial)): ?>
                                  value="<?php echo e($_REQUEST['serial']->serial); ?>"            
                              <?php endif; ?>
                           placeholder="Product Code/Serial">
                        </div>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  <thead>
                    <tr>
                      ...
                      <th><?php echo e(trans('labels.Serial')); ?></th>
