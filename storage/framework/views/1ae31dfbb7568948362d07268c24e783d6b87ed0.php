...
<div class="login-box">
  <div class="login-logo">
        <?php if($web_setting[66]->value=='1' and $web_setting[67]->value=='0'): ?>
      		<img src="<?php echo e(asset('/backend/images/admin_logo/logo-android-blue-v1.png')); ?>" class="ionic-hide"> 
        	<img src="<?php echo e(asset('/backend/images/admin_logo/logo-ionic-blue-v1.png')); ?>" class="android-hide"> 
        <?php elseif($web_setting[66]->value=='1' and $web_setting[67]->value=='1' or $web_setting[66]->value=='0' and $web_setting[67]->value=='1'): ?> 
   			<img src="<?php echo e(asset('/backend/images/admin_logo/logo-laravel-blue-v1.png')); ?>" class="website-hide"> 
    	<?php endif; ?>
    <div style="
    font-size: 25px;
...
<?php echo $__env->make('admin.layoutLlogin', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>