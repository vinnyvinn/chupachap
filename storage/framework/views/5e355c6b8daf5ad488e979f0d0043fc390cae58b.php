<h3 class="plugin-header">Best Sellers</h3>
<?php if($result['top_seller']['success']==1): ?>
            <ul class="plugin-item">  
                <?php $__currentLoopData = array_slice($result['top_seller']['product_data'], 0, 2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$top_seller): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <li>
