		...
		<div class="row">
			<div class="col-12 col-md-6 col-lg-7 new-customers">
				...
				<form name="signup" enctype="multipart/form-data" class="form-validate" action="<?php echo e(URL::to('/signupProcess')); ?>" method="post">
                	...
                	<div class="form-group row justify-content-center">
                        ...
                        <div class="uploader">
                            ...
                            <div class="upload-picture">
                                ...
                                <img class="upload-choose-icon" src="<?php echo e(asset('').'images/default_images/user.png'); ?>" />
					...
					<div class="form-group row">
						<label for="inputPassword" class="col-sm-4 col-form-label"><strong>*</strong>Phone No</label>
						<div class="col-sm-8">
							<input type="number" name="customers_telephone" id="customers_telephone" class="form-control field-validate" value="<?php echo e(old('customers_telephone')); ?>">
