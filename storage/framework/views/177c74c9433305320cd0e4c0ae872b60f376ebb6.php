							...
							<tr>
                              ...
                              <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <?php if($listingCustomers->enrolled ==0): ?>
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="#" id="enroll" class="label label-info" onclick="enrolled(<?php echo e($listingCustomers->customers_id); ?>)">Enroll</a></li>
                                  <?php elseif($listingCustomers->enrolled ==1): ?>
                                        <li role="presentation"><a role="menuitem" tabindex="-1" href="#" class="label label-success">Enrolled</a> </li>
                                    <?php endif; ?>
