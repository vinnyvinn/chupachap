                         ...
                         <div class="box-body">
                          ...
                          @endif
                            ...
                            {!! Form::open(array('url' =>'admin/updateproduct', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                              ...
                              <hr>
                              <div class="form-group">
                                  <label for="serial" class="col-sm-2 col-md-3 control-label">{{ trans('labels.Serial')}} <span class="text-primary">(Note:This is system generated)</span></label>
                                  <div class="col-sm-10 col-md-4">
                                     @if(count($result['product'][0]->serial) > 0 )
                                     <input type="text" class="form-control old" name="serial" value="{{ $result['product'][0]->serial }}" >
                                     @else
                                     <input type="text" class="form-control" name="serial" value="{{ $pref }}-{{ $key }} " >
                                    @endif
                                    </div>
                              </div>
                                <hr>
