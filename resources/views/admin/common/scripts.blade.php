...
@if(Request::path() == 'backend/dashboard/last_year' or Request::path() == 'backend/dashboard/last_month' or Request::path() == 'backend/dashboard/this_month')
...
$(document).on('click', '.add-value', function(e){
	...
	$.ajax({
		url: '{{ URL::to("backend/addattributevalue")}}',
		type: "POST",
		data: formData,
...
$(document).on('click', '.update-value', function(e){
	...
	$.ajax({
		url: '{{ URL::to("backend/updateattributevalue")}}',
		type: "POST",
		data: formData,
		success: function (res) {
				$('.addError').hide();
...
$(document).on('click', '#deleteAttribute', function(e){
	...
	var formData = parentFrom.serialize();
	$.ajax({
		url: '{{ URL::to("backend/deletevalue")}}',
		type: "POST",
		data: formData,
		success: function (res) {
				$('.addError').hide();
...
$(document).on('click', '#addAttribute', function(e){
	...
	$.ajax({
		url: '{{ URL::to("backend/addnewproductattribute")}}',
		type: "POST",
		data: formData,
		success: function (res) {
...
$(document).on('click', '#addDefaultAttribute', function(e){
	...
	$.ajax({
		url: '{{ URL::to("backend/addnewdefaultattribute")}}',
		type: "POST",
		data: formData,
		success: function (res) {
...
$(document).on('click', '#addAddress', function(e){
	...
	$.ajax({
		url: '{{ URL::to("backend/addNewCustomerAddress")}}',
		type: "POST",
		data: formData,
		async: false,
		success: function (res) {
...
$(document).on('click', '.editAddressModal', function(){
	...
	$.ajax({
		url: "{{ URL::to('backend/editAddress')}}",
		type: "POST",
...
$(document).on('click', '.editproductattributemodal', function(){
	...
	$.ajax({
		url: '{{ URL::to("backend/editproductattribute")}}',
		type: "POST",
...
$(document).on('click', '.editdefaultattributemodal', function(){
	...
	var options_id = $(this).attr('options_id');
	$.ajax({
		url: "{{ URL::to('backend/editdefaultattribute')}}",
		type: "POST",
		data: '&products_id='+products_id+'&products_attributes_id='+products_attributes_id+'&language_id='+language_id+'&options_id='+options_id,
		success: function (data) {
...
$(document).on('click', '#updateAddress', function(e){
		...
		$.ajax({
			url: "{{ URL::to('backend/updateAddress')}}",
			type: "POST",
			data: formData,
			success: function (res) {
	...
	$(document).on('click', '#updateProductAttribute', function(e){
		...
		$.ajax({
			url: '{{ URL::to("backend/updateproductattribute")}}',
			type: "POST",
			data: formData,
			success: function (res) {
	...
	$(document).on('click', '#updateDefaultAttribute', function(e){
		...
		$.ajax({
			url: "{{ URL::to('backend/updatedefaultattribute')}}",
			type: "POST",
			data: formData,
			success: function (res) {
	...
	$(document).on('click', '#deleteAddressBtn', function(){
		...
		$.ajax({
			url: "{{ URL::to('backend/deleteAddress')}}",
			type: "POST",
			data: formData,
			success: function (res) {
	...
	$(document).on('click', '.deleteproductattributemodal', function(){
		...
		var products_attributes_id = $(this).attr('products_attributes_id');
		$.ajax({
			url: "{{ URL::to('backend/deleteproductattributemodal')}}",
			type: "POST",
	...
	$(document).on('click', '.deletedefaultattributemodal', function(){
		...
		var products_attributes_id = $(this).attr('products_attributes_id');
		$.ajax({
			url: "{{ URL::to('backend/deletedefaultattributemodal')}}",
			type: "POST",
			data: '&products_id='+products_id+'&products_attributes_id='+products_attributes_id,
			success: function (data) {
	...
	$(document).on('click', '.deleteOption', function(){
		...
		$.ajax({
			url: "{{ URL::to('backend/checkattributeassociate')}}",
			type: "POST",
	...
	$(document).on('click', '.delete-value', function(){
		...
		$.ajax({
			url: "{{ URL::to('backend/checkvalueassociate')}}",
			type: "POST",
...
function enrolled(customer_id) {
    var url = '{{url('admin/enroll')}}' + '/'+customer_id;
    var posturl = '{{url('admin/save-enroll')}}' + '/'+customer_id;
