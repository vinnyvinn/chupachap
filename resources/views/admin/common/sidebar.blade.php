        ...
        <li class="treeview {{ Request::is('admin/products') ? 'active' : '' }} {{ Request::is('admin/addproduct') ? 'active' : '' }} {{ Request::is('admin/editattributes/*') ? 'active' : '' }} {{ Request::is('admin/attributes') ? 'active' : '' }}  {{ Request::is('admin/addattributes') ? 'active' : '' }}  {{ Request::is('admin/editattributes/*') ? 'active' : '' }}">
          ...
          <ul class="treeview-menu">
            <li class="{{ Request::is('admin/products') ? 'active' : '' }} {{ Request::is('admin/addproduct') ? 'active' : '' }} {{ Request::is('admin/editproduct/*') ? 'active' : '' }}"><a href="{{ URL::to('admin/products')}}"><i class="fa fa-circle-o"></i> {{ trans('labels.link_all_products') }}</a></li>
              <li class="{{ Request::is('admin/import') ? 'active' : '' }} {{ Request::is('admin/import') ? 'active' : '' }} {{ Request::is('admin/import/*') ? 'active' : '' }}"><a href="{{ URL::to('admin/import')}}"><i class="fa fa-circle-o"></i> Import Products</a></li>
          ...
          <li class="treeview {{ Request::is('admin/customers') ? 'active' : '' }}">
              <a href="#">
                  <i class="fa fa-users"></i> <span>{{ trans('labels.link_customers') }}</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                  <li class="{{ Request::is('admin/customers') ? 'active' : '' }} "><a href="{{ URL::to('admin/customers')}}"><i class="fa fa-circle-o"></i> All Customers</a></li>
                  <li class="{{ Request::is('admin/points') ? 'active' : '' }} "><a href="{{ URL::to('admin/points')}}"><i class="fa fa-circle-o"></i> Customer Loyalty Points</a></li>

                  <li class="{{ Request::is('admin/attributes') ? 'active' : '' }}" ><a href="{{ URL::to('admin/policies' )}}"><i class="fa fa-circle-o"></i> Loyalty Policy</a></li>
              </ul>
          </li>
...
<span>{{ trans('labels.link_tax_location') }}</span> <i class="fa fa-angle-left pull-right"></i>
        ...
        <li class="treeview {{ Request::is('admin/coupons') ? 'active' : '' }} {{ Request::is('admin/editcoupons/*') ? 'active' : '' }}">
          ...
          <li class="treeview {{ Request::is('admin/init-sms') ? 'active' : '' }}">
              <a href="#">
                  <i class="fa fa-send-o"></i> <span>Bulk SMS</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                  <li class="{{ Request::is('admin/init-sms') ? 'active' : '' }} "><a href="{{ URL::to('admin/init-sms')}}"><i class="fa fa-circle-o"></i> Bulk SMS</a></li>
                  <li class="{{ Request::is('admin/send-messages') ? 'active' : '' }} "><a href="{{ URL::to('admin/send-messages')}}"><i class="fa fa-circle-o"></i> Sent Messages</a></li>
                  <li class="{{ Request::is('admin/date-from') ? 'active' : '' }} "><a href="{{ URL::to('admin/date-from')}}"><i class="fa fa-circle-o"></i> Reports</a></li>
...
<span>{{ trans('labels.link_notifications') }}</span> <i class="fa fa-angle-left pull-right"></i>
        ...
        <li class="treeview {{ Request::is('admin/orders') ? 'active' : '' }}  {{ Request::is('admin/addOrders') ? 'active' : '' }}  {{ Request::is('admin/vieworder/*') ? 'active' : '' }}">
          <a href="{{ URL::to('admin/orders')}}" >
            ...
            <span> {{ trans('labels.link_orders') }}</span> <i class="fa fa-angle-left pull-right"></i>
          </a>
          <ul class="treeview-menu">
              <li class="{{ Request::is('admin/orders') ? 'active' : '' }} {{ Request::is('admin/orders/*') ? 'active' : '' }}">
                <a href="{{ URL::to('admin/orders')}}"><i class="fa fa-circle-o"></i>{{ trans('labels.link_orders') }} </a>
              </li> 
              <li class="{{ Request::is('admin/orders') ? 'active' : '' }} {{ Request::is('admin/orders/*') ? 'active' : '' }}">
                <a href="{{ URL::to('admin/orderforclient')}}"><i class="fa fa-circle-o"></i>{{ trans('labels.orderforcustomer') }} </a>
              </li>  
