      ...
      <div class="navbar-custom-menu">
        {{--<ul>--}}
          {{--<li class="cart-header dropdown head-cart-content">--}}
            {{--@include('cart-button-custom')--}}
          {{--</li>--}}
        {{--</ul>--}}

        <ul class="nav navbar-nav">
          <li class="dropdown messages-menu">
            <a href="{{ URL::to('/viewcart')}}" class="btn btn-dark">
              <i class="fa fa-eye"  style="font-size:18px"></i>

              <span class="title">@lang('website.View Cart')</span>
              @if(count($cart_data)>0)
                <span class="items">{{ count($cart_data) }}&nbsp;@lang('website.items')</span>
              @else
                    ...
                    <a href="{{ URL::to("admin/viewOrder")}}/{{ $unseenOrder->orders_id}}">
                      <div class="pull-left">
                         ...
                         @if(!empty($unseenOrder->customers_picture))
                            ...
                            @else
                            <img src="{{asset('backend/images/default_images/user.png')}}" class="img-circle" alt="{{ $unseenOrder->customers_name }} Image">
                         @endif
                    ...
                    <a href="{{ URL::to("admin/editCustomers")}}/{{ $newCustomer->customers_id}}">
                      <div class="pull-left">
                         @if(!empty($newCustomer->customers_picture))
                            ...
                            @else
                            <img src="{{asset('backend/images/default_images/user.png') }}" class="img-circle" alt="{{ $newCustomer->customers_firstname }} Image">
                         @endif
                      </div>
                      <h4>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="{{ URL::to('backend')}}" class="btn btn-default btn-flat">{{ trans('labels.sign_out') }}</a>
                </div>
              </li>
            </ul>
          </li>
