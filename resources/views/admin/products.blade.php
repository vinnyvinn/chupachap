        ...
        <div class="box">
          <div class="box-header">
            ...
            <div class="box-tools pull-right">
                <a href="{{ URL::to('admin/importproducts') }}" type="button" class="btn btn-success">{{ trans('labels.ImportNewProducts') }}</a>
            	<a href="{{ URL::to('admin/addproduct') }}" type="button" class="btn btn-primary">{{ trans('labels.AddNewProducts') }}</a>
            </div>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
