			...
			<div class="col-12 col-md-6 col-lg-7 new-customers">
				...
				<form name="signup" enctype="multipart/form-data" class="form-validate" action="{{ URL::to('/signupProcess')}}" method="post">
                	...
                	<div class="form-group row justify-content-center">
                        ...
                        <div class="uploader">
                            ...
                            <div class="upload-picture">
                                ...
                                <img class="upload-choose-icon" src="{{asset('').'images/default_images/user.png'}}" />
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							<input type="number" name="customers_telephone" id="customers_telephone" class="form-control field-validate" value="{{ old('customers_telephone') }}">
