...
Route::group(['prefix' => 'admin'], function () {
	...
	Route::group(['namespace' => 'Admin'], function () {
		...
		Route::group(['middleware' => 'admin'], function () {
			...
			/*
			| Help Customer to place an order
			*/
		...
		*/
			...
			Route::get('/orderforclient', 'AdminOrdersController@orderforcustomer');	
			...
			//bulk sms
       Route::get("init-sms","SendSmsController@initialize");
       Route::post("send-sms","SendSmsController@sendSms");
       Route::get("send-messages","SendSmsController@sendMessages");
       Route::get("date-from","SendSmsController@dateFrom");
       Route::post("get-report","SendSmsController@getReport");
       Route::get('export-file/{type}/{from}/{to}', 'SendSmsController@downloadFile');



            //loyalty points
            Route::resource('points','LoyaltyPointsController');
            Route::get('debit/{id}','LoyaltyPointsController@debit');
            Route::get('redeem/{id}','LoyaltyPointsController@redeem');
            Route::get('transfer/{id}','LoyaltyPointsController@transfer');
            Route::post('update-debit','LoyaltyPointsController@updateDebit');
            Route::post('update-redeem','LoyaltyPointsController@updateRedeem');
            Route::post('update-transfer','LoyaltyPointsController@updateTransfer');
            Route::get('/enroll/{id}', 'LoyaltyPointsController@enroll');
            Route::post('/save-enroll/{id}', 'LoyaltyPointsController@SaveEnroll');
            ...
            //import products
            Route::resource('import','ImportProductsController');
            Route::post('import-excel','ImportProductsController@importExcel');
            Route::get('downloadExcel/{type}','ImportProductsController@downloadExcel');
...
|
*/
//Route::get('/', 'AgeverifyController@index');
...
Route::post('/language/', array(
	...
	Route::post('/ageverfiy', 'DefaultController@index')->name('ageverfiy');
	Route::get('/index', 'DefaultController@verified')->name('ageverfied');
	...
	*/
    ...
    Route::get('/confirmation', 'CustomersController@paymentconfirmation');
    Route::get('/donepayment', 'CustomersController@paymentsuccess');
	...
	*/
	...
	Route::group(['middleware' => 'Customer'], function () {
        ...
        Route::get('/complete-checkout', 'OrdersController@completeCheckout');
        Route::get('/sms-me', 'OrdersController@smsNow');
		  //payments
        Route::get('/confirmation', 'OrdersController@paymentconfirmation');
