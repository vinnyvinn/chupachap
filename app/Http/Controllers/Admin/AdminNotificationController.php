...
class AdminNotificationController extends Controller
{
	...
	public function devices(Request $request){
		...
		return view("admin.devices",$title)->with('result', $result)->with('cart_data',$cart_data);
	}
	...
	public function viewdevices(Request $request){
		...
		$result['devices'] = $devices;	
		return view("admin.viewdevices",$title)->with('result', $result)->with('cart_data',$cart_data);
	}
	...
	public function notifications(Request $request){
		...
		return view("admin.notifications", $title)->with('result', $result)->with('cart_data',$cart_data);
	}
