...
class AdminReportsController extends Controller
{
	...
	public function statsCustomers(Request $request){
		...
		return view("admin.statsCustomers",$title)->with('result', $result)->with('cart_data',$cart_data);
	}
	...
	public function statsProductsPurchased(Request $request){
		...
		return view("admin.statsProductsPurchased",$title)->with('result', $result)->with('cart_data',$cart_data);
	}
	...
	public function statsProductsLiked(Request $request){
		...
		return view("admin.statsProductsLiked",$title)->with('result', $result)->with('cart_data',$cart_data);
	}
	...
	public function productsStock(Request $request){
		...
		return view("admin.productsStock",$title)->with('result', $result)->with('cart_data',$cart_data);
	}
