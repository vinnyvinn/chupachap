...
class AdminSlidersController extends Controller
{
	...
	public function sliders(Request $request){
		...
		return view("admin.sliders", $title)->with('result', $result)->with('cart_data',$cart_data);
	}
	...
	public function addsliderimage(Request $request){
		...
		return view("admin.addsliderimage", $title)->with('result', $result)->with('cart_data',$cart_data);
	}
	...
	public function editslide(Request $request){
		...
		return view("admin.editslide",$title)->with('result', $result)->with('cart_data',$cart_data);
	}
