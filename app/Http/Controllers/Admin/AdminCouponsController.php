...
{	
	...
	public function coupons(Request $request){
		...
		return view("admin.coupons", $title)->with('result', $result)->with('cart_data',$cart_data);
	}
	...
	public function addcoupons(Request $request){
		...
		return view("admin.addcoupons", $title)->with('result', $result)->with('cart_data',$cart_data);
	}
	...
	public function editcoupons(Request $request){
		...
		return view("admin.editcoupons", $title)->with('result', $result)->with('cart_data',$cart_data);
	}
