...
class AdminBannersController extends Controller
{
	...
	public function banners(Request $request){
		...
		return view("admin.banners", $title)->with('result', $result)->with('cart_data',$cart_data);
	}
	...
	public function addbanner(Request $request){
		...
		return view("admin.addbanner", $title)->with('result', $result)->with('cart_data',$cart_data);
	}
	...
	public function editbanner(Request $request){
		...
		return view("admin.editbanner",$title)->with('result', $result)->with('cart_data',$cart_data);
	}
