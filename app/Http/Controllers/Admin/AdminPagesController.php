...
class AdminPagesController extends Controller
{
	...
	public function pages(Request $request){
		...
		$result["pages"] = $pages;
		return view("admin.pages",$title)->with('result', $result)->with('cart_data',$cart_data);
	}
	...
	public function addpage(Request $request){
		...
		return view("admin.addpage", $title)->with('result', $result)->with('cart_data',$cart_data);
	}
	...
	public function editpage(Request $request){
		...
		return view("admin.editpage", $title)->with('result', $result)->with('cart_data',$cart_data);
	}
	...
	public function webpages(Request $request){
		...
		$result["pages"] = $pages;
		return view("admin.webpages",$title)->with('result', $result)->with('cart_data',$cart_data);
	}
	...
	public function addwebpage(Request $request){
		...
		return view("admin.addwebpage", $title)->with('result', $result)->with('cart_data',$cart_data);
	}
	...
	public function editwebpage(Request $request){
		...
		return view("admin.editwebpage", $title)->with('result', $result)->with('cart_data',$cart_data);
	}
