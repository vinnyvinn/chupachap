...
class AdminSiteSettingController extends Controller
{
	...
	public function orderstatus(Request $request){
		...
		return view("admin.orderstatus",$title)->with('result', $result)->with('cart_data',$cart_data);
	}
	...
	public function addorderstatus(Request $request){
		...
		return view("admin.addorderstatus",$title)->with('result', $result)->with('cart_data',$cart_data);
	}
	...
	public function editorderstatus(Request $request){
		...
		return view("admin.editorderstatus",$title)->with('result', $result)->with('cart_data',$cart_data);
	}
	...
	public function languages(Request $request){
		...
		return view("admin.languages",$title)->with('result', $result)->with('cart_data',$cart_data);
	}
	...
	public function addlanguages(Request $request){
		...
		return view("admin.addlanguages",$title)->with('cart_data',$cart_data);
	}
	...
	public function editlanguages(Request $request){
		...
		return view("admin.editlanguages",$title)->with('result', $result)->with('cart_data',$cart_data);
	}
	...
	public function setting(Request $request){
		...
		return view("admin.setting",$title)->with('result', $result)->with('cart_data',$cart_data);
	}
	...
	public function applicationApi(Request $request){
		...
		return view("admin.applicationApi",$title)->with('result', $result)->with('cart_data',$cart_data);
	}
	//setting page
	...
	public function webSettings(Request $request){
		...
		return view("admin.webSettings",$title)->with('result', $result)->with('cart_data',$cart_data);
	}
	...
	public function customstyle(Request $request){
		...
		$settings = DB::table('settings')->get();		
		$result['settings'] = $settings;		
		return view("admin.customstyle",$title)->with('result', $result)->with('cart_data',$cart_data);
	}
	...
	public function appSettings(Request $request){
		...
		return view("admin.appSettings",$title)->with('result', $result)->with('cart_data',$cart_data);
	}
	...
	public function seo(Request $request){
		...
		return view("admin.seo",$title)->with('result', $result)->with('cart_data',$cart_data);
	}
	...
	public function admobSettings(Request $request){
		...
		return view("admin.admobSettings",$title)->with('result', $result)->with('cart_data',$cart_data);
	}
	...
	public function facebookSettings(Request $request){
		...
		return view("admin.facebookSettings",$title)->with('result', $result)->with('cart_data',$cart_data);
	}
	...
	public function googleSettings(Request $request){
		...
		return view("admin.googleSettings",$title)->with('result', $result)->with('cart_data',$cart_data);
	}
	...
	public function alertSetting(Request $request){
		...
		return view("admin.alertSetting",$title)->with('result', $result)->with('cart_data',$cart_data);
	}
	...
	public function webthemes(Request $request){
		...
		return view("admin.webthemes",$title)->with('result', $result)->with('cart_data',$cart_data);
	}
	...
	public function pushNotification(Request $request){
		...
		$settings = DB::table('settings')->get();		
		$result['settings'] = $settings;	
		return view("admin.pushNotification",$title)->with('result', $result)->with('cart_data',$cart_data);
	}
	...
	public function units(Request $request){
		...
		return view("admin.units",$title)->with('result', $result)->with('cart_data',$cart_data);
	}
	...
	public function addunit(Request $request){
		...
		return view("admin.addunit",$title)->with('result', $result)->with('cart_data',$cart_data);
	}
	...
	public function editunit(Request $request){
		...
		$result['units'] = $units;			
		return view("admin.editunit",$title)->with('result', $result)->with('cart_data',$cart_data);
	}
