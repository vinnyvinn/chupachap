...
class AdminTaxController extends Controller
{
	...
	public function countries(Request $request){
		...
		return view("admin.countries",$title)->with('countryData', $countryData)->with('cart_data',$cart_data);
	}
	...
	public function addcountry(Request $request){
		...
		return view("admin.addcountry",$title)->with('countryData', $countryData)->with('cart_data',$cart_data);
	}
	...
	public function editcountry(Request $request){
		...
		return view("admin.editcountry",$title)->with('countryData', $countryData)->with('cart_data',$cart_data);
	}
	...
	public function listingZones(Request $request){
		...
		return view("admin.listingZones",$title)->with('result', $result)->with('cart_data');
	}
	...
	public function addZone(Request $request){
		...
		return view("admin.addZone", $title)->with('result', $result)->with('cart_data',$cart_data);
	}
	...
	public function editZone(Request $request){
		...
		return view("admin.editZone",$title)->with('result', $result)->with('cart_data',$cart_data);
	}
	...
	public function taxclass(Request $request){
		...
		return view("admin.taxclass", $title)->with('result', $result)->with('cart_data',$cart_data);
	}
	...
	public function addtaxclass(Request $request){
		...
		return view("admin.addtaxclass", $title)->with('result', $result)->with('cart_data',$cart_data);
	}
	...
	public function edittaxclass(Request $request){
		...
		return view("admin.edittaxclass",$title)->with('result', $result)->with('cart_data',$cart_data);
	}
	...
	public function taxrates(Request $request){
		...
		return view("admin.taxrates", $title)->with('result', $result)->with('cart_data',$cart_data);
	}
	...
	public function addtaxrate(Request $request){
		...
		return view("admin.addtaxrate", $title)->with('result', $result)->with('cart_data',$cart_data);
	}
	...
	public function edittaxrate(Request $request){
		...
		return view("admin.edittaxrate",$title)->with('result', $result)->with('cart_data',$cart_data);
	}
