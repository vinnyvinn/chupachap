...
class AdminAppLabelsController extends Controller
{
	...
	public function listingAppLabels(Request $request){
		...
		return view("admin.listingAppLabels", $title)->with('result', $result)->with('cart_data',$cart_data);
	}
	...
	public function manageAppLabel(Request $request){
		...
		$result['labels'] = $data;
		return view("admin.manageAppLabel", $title)->with('result', $result)->with('cart_data',$cart_data);
	}
