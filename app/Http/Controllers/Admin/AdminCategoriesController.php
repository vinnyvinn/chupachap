...
class AdminCategoriesController extends Controller
{
	...
	public function categories(){
		...
		return view("admin.categories",$title)->with('categories', $categories)->with('cart_data',$cart_data);
	}
	...
	public function addcategory(Request $request){
		...
		return view("admin.addcategory",$title)->with('result', $result)->with('cart_data',$cart_data);
	}
	...
	public function editcategory(Request $request){
		...
		return view("admin.editcategory", $title)->with('result', $result)->with('cart_data',$cart_data);
	}
	...
	public function subcategories(){
		...
		return view("admin.subcategories",$title)->with('listingSubCategories', $listingSubCategories)->with('cart_data',$cart_data);
	}
	...
	public function addsubcategory(Request $request){
		...
		return view("admin.addsubcategory",$title)->with('result', $result)->with('cart_data',$cart_data);
	}
	...
	public function editsubcategory(Request $request){
		...
		return view("admin.editsubcategory",$title)->with('result', $result)->with('cart_data',$cart_data);
	}
