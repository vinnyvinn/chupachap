...
class AdminManufacturerController extends Controller
{
	public function manufacturers(){
		...
		return view("admin.manufacturers",$title)->with('manufacturers', $manufacturers)->with('cart_data',$cart_data);
	}
	
	public function addmanufacturer(Request $request){
        $cart_data= PaymentsRepo::init()->cartContent();
		$title = array('pageTitle' => Lang::get("labels.AddManufacturer"));
		return view("admin.addmanufacturer",$title)->with('cart_data',$cart_data);
	}
	...
	public function editmanufacturer(Request $request){
		...
		return view("admin.editmanufacturer",$title)->with('editManufacturer', $editManufacturer)->with('cart_data',$cart_data);
	}
