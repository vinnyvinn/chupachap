...
class AdminCustomersController extends Controller
{
	...
	public function customers(Request $request){
		...
		return view("admin.customers",$title)->with('customers', $customerData)->with('cart_data',$cart_data);
	}
	...
	public function addcustomers(Request $request){
		...
		return view("admin.addcustomers",$title)->with('customers', $customerData)->with('cart_data',$cart_data);
	}
	...
	public function addaddress(Request $request){
		...
		return view("admin.addaddress",$title)->with('data', $customerData)->with('cart_data',$cart_data);
	}
	...
	public function editAddress(Request $request){
		...
		return view("admin/editAddressForm")->with('data', $customerData)->with('cart_data',$cart_data);
	}
	...
	public function editcustomers(Request $request){
		...
		return view("admin.editcustomers",$title)->with('data', $customerData)->with('cart_data',$cart_data);
	}
