...
class AdminNewsCategoriesController extends Controller
{
	...
	public function newscategories(){
		...
		return view("admin.newscategories",$title)->with('listingCategories', $listingCategories)->with('cart_data',$cart_data);
	}
	...
	public function addnewscategory(Request $request){
		...
		return view("admin.addnewscategory",$title)->with('result', $result)->with('cart_data',$cart_data);
	}
	...
	public function editnewscategory(Request $request){
		...
		return view("admin.editnewscategory", $title)->with('result', $result)->with('cart_data',$cart_data);
	}
