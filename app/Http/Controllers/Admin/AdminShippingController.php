...
class AdminShippingController extends Controller
{
	...
	public function shippingmethods(Request $request){
		...
		return view("admin.shippingmethods", $title)->with('result', $result)->with('cart_data',$cart_data);
	}
	...
	public function upsShipping(Request $request){
		...
		return view("admin.upsShipping", $title)->with('result', $result)->with('cart_data',$cart_data);
	}
	...
	public function flaterate(Request $request){
		...
		$result['description'] = $description_data;			
		return view("admin.flateRate", $title)->with('result', $result)->with('cart_data',$cart_data);
	}
	...
	public function shippingDetail(Request $request){
		...
		return view("admin.shippingDetail", $title)->with('result', $result)->with('cart_data',$cart_data);
	}
